...
class TourGuidesView extends StatefulWidget {
  const TourGuidesView({super.key});

  @override
  State<TourGuidesView> createState() => _TourGuidesViewState();
}
const List<String> list = <String>['uid', 'email', 'username', 'fullname', 'icNumber', 'description'];
// const List<String> list = <String>['One', 'Two', 'Three', 'Four'];

class _TourGuidesViewState extends State<TourGuidesView> {
                          ...
                          function: () => Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (context) => TourGuideDetail(
                                tourGuideDetailSnap: documents[index].data(),
                              ),
                            ),
                          ),
                          index: index,
