...
class TourPackagesView extends StatefulWidget {
  const TourPackagesView({super.key});

  @override
  State<TourPackagesView> createState() => _TourPackagesViewState();
}
const List<String> list = <String>['packageId', 'packageTitle', 'content', 'ownerId'];

class _TourPackagesViewState extends State<TourPackagesView> {
