...
import 'package:fyp_admin_app/ui_view/detail/licence_verification.dart';
...
class LicenceVerificationsView extends StatefulWidget {
  const LicenceVerificationsView({super.key});

  @override
  State<LicenceVerificationsView> createState() => _LicenceVerificationsViewState();
}
const List<String> list = <String>['licenceId', 'ownerId'];

class _LicenceVerificationsViewState extends State<LicenceVerificationsView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: MainAppBar(title: "Licence Verifications"),
                      ...
                      itemBuilder: (ctx, index) =>
                          Container(
                            child: DatabaseCard(
                              ...
                              documentId: "licenceId",
                              function: () => Navigator.of(context).push(
                                MaterialPageRoute(
                                  builder: (context) => LicenceVerificationDetail(
                                    snap: documents[index].data(),
                                  ),
                                ),
                              ),
