...
class InstantOrdersView extends StatefulWidget {
  const InstantOrdersView({super.key});

  @override
  State<InstantOrdersView> createState() => _InstantOrdersViewState();
}
const List<String> list = <String>['orderID', 'ownerID'];

class _InstantOrdersViewState extends State<InstantOrdersView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: MainAppBar(title: "Instant Orders"),
                          ...
                          Container(
                            child: DatabaseCard(
                              ...
                              function: () => Navigator.of(context).push(
                                MaterialPageRoute(
                                  builder: (context) => InstantOrderDetail(
                                    snap: documents[index].data(),
                                  ),
                                ),
                              ),
